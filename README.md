...
- documents -> Final report, PDF report, and screenshots

### code file contains
- SeasonFinder.java -> contains season finding methods and functionalities
- TemperatureChecker.java -> contains temperature checking method and functionalities
- Menu.java -> This a menu file that is used to run the program
...
2. Run the menu file by : "java Menu"
3. To run the test harness for season: "java SeasonTestHarness"
4. To run the test harness for temperature: "java TemperatureTestHarness"
